...
struct ServiceError: Error, LocalizedError {
    ...
    enum ErrorLocalizedDescription: String {
        ...
        case socketIdNotFound                   = "Socket id not found."
        case ghRouteRequest                     = "Issue creating route request."
        case routeResultNotFound                = "Route result not found."
        case routeOptimizeSolutionNotFound      = "Route optimize solution not found."
        case routeOptimizeActivitiesNotFound    = "Route optimize activities not found."
